...
namespace RightWay.Data.Migrations
{
    ...
    [Migration("20250722222657_RemoveIsRequiredLatitudeAndLogitudeAddress")]
    partial class RemoveIsRequiredLatitudeAndLogitudeAddress
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RightWay.Domain.Entity.Base.BaseAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("base_address", (string)null);
                });
            ...
            modelBuilder.Entity("RightWay.Domain.Entity.Address", b =>
                {
                    b.HasOne("RightWay.Domain.Entity.Base.BaseAddress", "BaseAddress")
                        .WithMany("Addresses")
                        .HasForeignKey("BaseAddressId")
